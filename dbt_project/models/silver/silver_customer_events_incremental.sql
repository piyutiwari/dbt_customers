{{
  config(
    ...
    tags=['silver', 'customer_events', 'incremental']
  )
}}

-- Silver layer: Incremental customer events for efficient processing of large event streams
-- Only processes new events since last run based on event_timestamp
